...
import { ArrowLeft, Download, Menu, Share2, X, ZoomIn } from 'lucide-react'
...
export default function PDFViewerPage() {
  ...
  const handleScreenTouch = useCallback(() => {
    setShowControls(prev => {
      ...
      } else if (controlTimeoutRef.current) {
        clearTimeout(controlTimeoutRef.current)
  ...
  }, [handleGoBack, handleScreenTouch])
  ...
  return (
    <div className="min-h-screen bg-black relative select-none">
      ...
      {/* PDF 뷰어 */}
      <div className="h-screen w-full" onClick={handleScreenTouch} onTouchStart={handleScreenTouch}>
        {isLoading && (
