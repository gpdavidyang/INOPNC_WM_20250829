...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(e)
      : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).SignaturePad = e())
})(this, function () {
  'use strict'
  class t {
    constructor(t, e, i, s) {
    ...
    equals(t) {
      return (
        this.x === t.x && this.y === t.y && this.pressure === t.pressure && this.time === t.time
      )
    }
    velocityFrom(t) {
  ...
  class s extends i {
    ...
    _getPointGroupOptions(t) {
      return {
        ...
        compositeOperation:
          t && 'compositeOperation' in t ? t.compositeOperation : this.compositeOperation,
      }
    }
    _strokeBegin(t) {
