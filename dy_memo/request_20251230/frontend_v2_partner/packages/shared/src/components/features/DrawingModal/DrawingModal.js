...
const DrawingModal = ({ isOpen, onClose, imageSrc, onSave }) => {
  ...
  const previewDragStart = useRef(null)
  ...
  return _jsxs('div', {
    className: 'fixed inset-0 bg-[#111827] z-50 flex flex-col',
    children: [
      _jsxs('div', {
        className:
          'h-[52px] bg-header-navy flex items-center justify-between px-3 text-white border-b border-white/10 shrink-0',
        children: [
          _jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              _jsx('button', { onClick: onClose, children: _jsx(X, { className: 'w-6 h-6' }) }),
              _jsx('span', { className: 'font-bold', children: '\uB3C4\uBA74 \uB9C8\uD0B9' }),
            ],
          }),
          _jsxs('div', {
            ...
            children: [
              _jsxs('button', {
                ...
                children: [_jsx(RotateCcw, { className: 'w-3 h-3' }), ' \uCDE8\uC18C'],
              }),
              _jsxs('button', {
                onClick: handleClearAll,
                className: 'flex items-center gap-1 px-2 py-1 bg-white/10 rounded-lg text-xs',
                children: [_jsx(Eraser, { className: 'w-3 h-3' }), ' \uC9C0\uC6B0\uAE30'],
              }),
              _jsxs('button', {
                onClick: handlePreview,
                className: 'flex items-center gap-1 px-2 py-1 bg-white/10 rounded-lg text-xs',
                children: [_jsx(ScanEye, { className: 'w-3 h-3' }), ' \uBBF8\uB9AC\uBCF4\uAE30'],
              }),
              _jsxs('button', {
                onClick: handleSave,
                className:
                  'flex items-center gap-1 px-3 py-1 bg-primary rounded-lg text-sm font-bold',
      ...
      _jsxs('div', {
        ref: containerRef,
        className:
          'flex-1 relative overflow-hidden bg-[#111827] flex items-center justify-center touch-none',
        children: [
          _jsx('canvas', {
            ref: canvasRef,
          ...
          textInput &&
            _jsx('div', {
              ...
              children: _jsxs('div', {
                className:
                  'bg-white p-4 rounded-xl shadow-2xl w-[90%] max-w-sm flex flex-col gap-3',
                children: [
                  _jsx('span', {
          ...
          isPreviewOpen &&
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  className:
                    'h-[52px] bg-black border-b border-gray-800 flex items-center justify-between px-3 shrink-0 text-white',
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('button', {
                          ...
                          children: _jsx(ChevronLeft, { className: 'w-6 h-6' }),
                        }),
                        _jsxs('span', {
                          className: 'font-bold truncate max-w-[200px]',
                          children: [
                            '\uB3C4\uBA74 \uB9C8\uD0B9 - ',
                            drawObjects.length > 0 ? `Object_${drawObjects.length}` : 'New',
                          ],
                        }),
                      ],
                    }),
                ...
                _jsx('div', {
                  ...
                  children: _jsx('img', {
                    ...
                    className:
                      'max-w-[90%] max-h-[80%] object-contain transition-transform duration-75',
                    alt: 'Preview',
                    draggable: false,
                  }),
                }),
                _jsxs('div', {
                  className:
                    'absolute bottom-8 left-1/2 -translate-x-1/2 bg-[#222]/90 backdrop-blur border border-white/10 px-6 py-2.5 rounded-full flex gap-6 shadow-2xl z-50',
                  children: [
                    _jsxs('button', {
                      onClick: () => setPreviewZoom(z => Math.max(0.5, z - 0.2)),
                      className:
                        'flex flex-col items-center gap-1 text-[10px] text-white/70 hover:text-white transition-colors',
                      children: [
                        _jsx(ZoomOut, { size: 18 }),
                        _jsx('span', { children: '\uCD95\uC18C' }),
                      ],
                    }),
                    _jsxs('button', {
                    ...
                    _jsxs('button', {
                      ...
                      children: [
                        _jsx(ZoomIn, { size: 18 }),
                        _jsx('span', { children: '\uD655\uB300' }),
                      ],
                    }),
                    _jsx('div', { className: 'w-px h-6 bg-white/20 self-center mx-1' }),
                    _jsxs('button', {
      ...
      _jsxs('div', {
        className: 'bg-white pb-safe shrink-0',
        children: [
          _jsx('div', {
            className: 'flex justify-around p-2 border-t border-slate-100',
            children: [
              ...
              _jsxs(
                'button',
                {
                  ...
                  className: `w-11 h-11 rounded-xl border flex flex-col items-center justify-center text-[10px] gap-0.5 transition-colors
                            ...
                            `,
                  children: [
                    _jsx(tool.icon, { className: 'w-5 h-5' }),
                    _jsx('span', { children: tool.label }),
                  ],
                },
                tool.id
              )
          ...
          _jsxs('div', {
            className:
              'flex items-center gap-2 px-2 py-2 border-t border-slate-100 overflow-x-auto no-scrollbar',
            children: [
              _jsx('div', {
                className: 'flex gap-2',
                children: ['blue', 'red', 'gray', 'green', 'orange', 'purple'].map(c =>
                  _jsx(
                    'button',
                    {
              ...
              _jsx('div', { className: 'w-px h-6 bg-slate-200 mx-1 shrink-0' }),
              _jsx('input', {
                type: 'range',
                min: '2',
                max: '100',
              ...
              _jsxs('button', {
                ...
                className:
                  'px-2 py-1 text-xs border rounded flex items-center gap-1 bg-slate-50 text-slate-600',
                children: [_jsx(Maximize2, { className: 'w-3 h-3' }), ' \uB9DE\uCDA4'],
              }),
            ],
          }),
          currentTool === 'stamp' &&
            _jsx('div', {
              className: 'flex justify-around p-2 bg-slate-50 gap-2 border-t border-slate-100',
              children: ['circle', 'square', 'triangle', 'star'].map(s =>
                _jsxs(
                  'button',
                  {
                    ...
                    children: [
                      s === 'circle' &&
                        _jsx('div', { className: 'w-4 h-4 rounded-full border-2 border-current' }),
                      s === 'square' &&
                        _jsx('div', { className: 'w-4 h-4 border-2 border-current' }),
                      s === 'triangle' &&
                        _jsx('div', {
                          className:
                            'w-0 h-0 border-l-[8px] border-r-[8px] border-b-[16px] border-l-transparent border-r-transparent border-b-current',
                        }),
                      s === 'star' && _jsx(Stamp, { className: 'w-4 h-4' }),
                    ],
                  },
                  s
                )
