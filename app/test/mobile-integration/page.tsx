...
export default function TestMobileIntegrationPage() {
  ...
  const [currentRole, setCurrentRole] = useState<'worker' | 'site_manager' | 'customer_manager'>(
    'worker'
  )
  ...
  return (
    <div>
      ...
      {/* Mobile Dashboard */}
      <MobileDashboardLayout user={mockUser} profile={{ ...mockProfile, role: currentRole }} />
    </div>
  )
}
