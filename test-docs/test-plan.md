...
| 경로 | 화면명 | 테스트 항목 | 우선순위 |
|------|--------|------------|----------|
| `/dashboard/admin/partners` | 파트너사 관리 | 업체 등록, 계약 관리, 평가 | 🟢 Medium |
| `/dashboard/admin/organizations` | 조직 관리 | 조직도, 부서 관리, 권한 설정 | 🟢 Medium |
...
| 경로 | 화면명 | 테스트 항목 | 우선순위 |
|------|--------|------------|----------|
| `/partner/dashboard` | 파트너 대시보드 | 프로젝트 현황, 작업 일정, 정산 | 🟢 Medium |
