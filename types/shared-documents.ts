...
export type DocumentCategory = '도면' | '계약서' | '보고서' | '사진' | 'PTW 작업허가서' | '기타'
...
export type UserRole = 'worker' | 'site_manager' | 'partner' | 'admin' | 'customer_manager'
...
export type DocumentAction = 'view' | 'download' | 'edit' | 'delete' | 'share' | 'upload'
