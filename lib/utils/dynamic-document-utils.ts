...
export class DynamicDocumentUtils {
  ...
  static async getDocumentTypes(roleType?: string, siteId?: string): Promise<DynamicDocumentType[]> {
    const now = Date.now()
    ...
    return [
      {
        ...
        description: '현장 작업을 위한 필수 안전 교육 이수 증명서',
      ...
      },
      {
        ...
        description: '현장 작업 적합성을 위한 건강상태 증명서',
        file_types: ['pdf', 'jpg', 'jpeg', 'png'],
        max_file_size: 10485760,
        sort_order: 2
      },
      {
        ...
        description: '산재보험, 건강보험 등 각종 보험 가입 증명서',
        file_types: ['pdf', 'jpg', 'jpeg', 'png'],
        max_file_size: 10485760,
        sort_order: 3
      },
      {
        ...
        description: '신분 확인을 위한 주민등록증 또는 운전면허증 사본',
        file_types: ['pdf', 'jpg', 'jpeg', 'png'],
        max_file_size: 10485760,
        sort_order: 4
      },
      {
        ...
        description: '해당 작업에 필요한 기술자격증 또는 면허증',
        file_types: ['pdf', 'jpg', 'jpeg', 'png'],
        max_file_size: 10485760,
        sort_order: 5
      },
      ...
      },
      {
        ...
        description: '프로젝트별 추가로 필요한 기타 서류',
