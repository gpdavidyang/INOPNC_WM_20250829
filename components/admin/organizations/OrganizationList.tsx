...
type SortField = 'name' | 'type' | 'phone' | 'is_active' | 'created_at'
                ...
                <tr>
                  <th className="px-6 py-3 text-left">
                    <button
                      ...
                      className="group flex items-center gap-1 text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider hover:text-gray-700 dark:hover:text-gray-100 transition-colors"
                    >
                      조직명
                      {getSortIcon('name')}
                    </button>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <button
                      onClick={() => router.push(`/dashboard/admin/organizations/${org.id}`)}
                      className="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:underline transition-colors text-left"
                    >
                      {org.name}
                    </button>
                  </div>
