...
import { FileText, Calendar, Users, MapPin, Eye, Edit } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">일일보고서 통합 관리</h3>
        <Link
      ...
      {reports.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 dark:text-gray-400">등록된 일일보고서가 없습니다</p>
        </div>
      ) : (
