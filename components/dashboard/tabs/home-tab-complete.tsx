...
export default function HomeTabComplete({ profile, onTabChange }: HomeTabProps) {
  ...
  const quickMenuItems: QuickMenuItem[] = [
    ...
    },
    {
      id: 'my-info',
      name: '내정보',
      iconUrl: 'https://postfiles.pstatic.net/MjAyNTA5MDlfMTAy/MDAxNzU3MzczOTIzODQw.3f7y5OVN_nZOVJZM5dpdzoXlzKCQ2Q6NNIR3A5mPYisg.kz4k0gHm4y7LZ7E95NhQGbPRJJGS2VoJvhxOoHcg6O8g.PNG/%EB%82%B4%EC%A0%95%EB%B3%B4.png?type=w966',
