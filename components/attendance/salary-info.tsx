    ...
    <div className="space-y-6">
      ...
      {isPartnerView ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card
            className={touchMode === 'glove' ? 'p-6' : touchMode === 'precision' ? 'p-3' : 'p-4'}
          >
            <div className="flex items-center justify-between">
              <div>
                <p
                  className={`${getFullTypographyClass('body', 'sm', isLargeFont)} text-gray-600 dark:text-gray-400`}
                >
                  총 작업자
                </p>
                <p className={`${getFullTypographyClass('heading', '2xl', isLargeFont)} font-bold`}>
                  {companySummary.totalWorkers}명
                </p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`${getFullTypographyClass('heading', 'xl', isLargeFont)} font-bold`}>
                  {formatCurrency(companySummary.totalAmount)}
                </p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`${getFullTypographyClass('heading', 'xl', isLargeFont)} font-bold text-amber-600`}
                >
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`${getFullTypographyClass('heading', 'xl', isLargeFont)} font-bold text-green-600`}
                >
      ...
      <Card className={touchMode === 'glove' ? 'p-8' : touchMode === 'precision' ? 'p-4' : 'p-6'}>
        ...
        {loading ? (
          <div
            className={`text-center py-8 ${getFullTypographyClass('body', 'base', isLargeFont)} text-gray-500`}
          >
            급여 정보를 불러오는 중...
          </div>
        ) : salaryData.length === 0 ? (
