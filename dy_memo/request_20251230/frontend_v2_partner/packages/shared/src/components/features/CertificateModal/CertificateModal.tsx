...
export const CertificateModal: React.FC<CertificateModalProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className="cert-scope fixed inset-0 z-[60] bg-[#1e1e1e] text-white flex flex-col h-full w-full"
    >
      {/* 
      ...
      */}
      <style>{`
        ...
        #toastMsg { white-space: nowrap; word-break: keep-all; }
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div id="modalEditLayer">
              ...
              <div className="modal-edit-controls">
                <span style={{ color: '#fff', fontSize: '12px', whiteSpace: 'nowrap' }}>크기</span>
                <input
                  type="range"
                  id="modalScaleSlider"
                  min="0.1"
          ...
          <div className="sign-tools-bar" id="signToolsBar">
            <button className="mini-btn active" id="btnPen" style={{ marginRight: '4px' }}>
              <i data-lucide="pen-tool" style={{ width: '14px', height: '14px' }}></i> 펜
            </button>
            <button className="mini-btn" id="btnEraser" style={{ marginRight: '10px' }}>
              <i data-lucide="eraser" style={{ width: '14px', height: '14px' }}></i> 지우개
            </button>
            ...
            >
              <i data-lucide="image-plus" style={{ width: '16px', height: '16px' }}></i> 도장/사진
            </button>
