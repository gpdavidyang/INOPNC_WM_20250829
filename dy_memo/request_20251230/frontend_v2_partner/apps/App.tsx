...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Floating Actions */}
      <div
        className={`sticky bottom-3 bg-bg-surface dark:bg-slate-800 p-2.5 rounded-2xl border border-border shadow-xl mb-5 z-40 transition-all ${isReadyToSave ? 'border-green-500 ring-4 ring-green-500/10' : ''}`}
      >
        {isReadyToSave && (
