...
const WeatherResistantButton = forwardRef<HTMLButtonElement, WeatherResistantButtonProps>(
  (
    { className, variant = 'primary', size = 'md', children, isWeatherMode = true, ...props },
    ref
  ) => {
    const baseClasses = cn(
      ...
      {
        // Primary variant
        'bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white border-blue-700 focus-visible:ring-blue-500':
          variant === 'primary',

        // Secondary variant
        'bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-900 border-gray-300 focus-visible:ring-gray-500':
          variant === 'secondary',

        // Danger variant
        'bg-red-600 hover:bg-red-700 active:bg-red-800 text-white border-red-700 focus-visible:ring-red-500':
          variant === 'danger',

        // Success variant
        'bg-green-600 hover:bg-green-700 active:bg-green-800 text-white border-green-700 focus-visible:ring-green-500':
          variant === 'success',
      },

      // Weather-resistant variant enhancements
      isWeatherMode && {
        'bg-blue-700 hover:bg-blue-800 border-blue-800 ring-4 ring-blue-500/20':
          variant === 'primary',
        'bg-gray-200 hover:bg-gray-300 border-gray-400 ring-4 ring-gray-500/20':
          variant === 'secondary',
        'bg-red-700 hover:bg-red-800 border-red-800 ring-4 ring-red-500/20': variant === 'danger',
        'bg-green-700 hover:bg-green-800 border-green-800 ring-4 ring-green-500/20':
          variant === 'success',
      },
