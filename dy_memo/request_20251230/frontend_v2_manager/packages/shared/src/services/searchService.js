class SearchService {
  constructor() {
    ...
    Object.defineProperty(this, 'prefixBucket', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: new Map(),
  ...
  addToBucket(normalizedTitle, id) {
  ...
  search(query, filterType = 'ALL', limit = 50) {
  ...
  loadMockData() {
    ...
    const types = ['SITE', 'LOG', 'DOC', 'PHOTO', 'DRAWING', 'EXPENSE']
