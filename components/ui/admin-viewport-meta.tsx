  ...
  useEffect(() => {
    ...
    if (role === 'admin' || role === 'system_admin') {
      ...
      if (isMobile) {
        ...
        viewport.content = 'width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=3.0, user-scalable=yes'
      } else {
        // Desktop field workers: Standard responsive viewport
        viewport.content = 'width=device-width, initial-scale=1.0, minimum-scale=0.8, maximum-scale=2.0, user-scalable=yes'
      }
    } else {
