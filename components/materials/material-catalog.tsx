...
export function MaterialCatalog({ materials, categories, searchQuery }: MaterialCatalogProps) {
  ...
  const tableColumns = [
    ...
    },
    {
      ...
      align: 'center' as const,
      width: '100px',
      render: (value: number, material: unknown) => (value ? `${value} ${material.unit}` : '-'),
    },
    {
      key: 'actions',
      label: '작업',
    ...
    <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              {Array.from(categoryHierarchy.values()).map(rootCategory => (
                <div key={rootCategory.id} className="space-y-1">
                  ...
                  {expandedCategories.has(rootCategory.id) &&
                    Array.isArray(rootCategory.children) && (
        ...
        <div className="col-span-1 lg:col-span-3 space-y-4">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-900 mt-1">총 {filteredMaterials.length}개의 자재</p>
            </div>
          ...
          {filteredMaterials.length > 0 ? (
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {material.supplier && (
                          <div className="flex items-center gap-2 text-gray-900">
                            ...
                            <span>시공업체: {material.supplier}</span>
                          </div>
                        )}
                      </div>
            ...
            <Card className="p-8 text-center">
              ...
              <Button
                ...
                className="gap-2"
              >
                <Plus className="h-4 w-4" />첫 번째 자재 추가
              </Button>
            </Card>
          )}
        </div>
      ...
      <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>{editingMaterial ? '자재 수정' : '새 자재 추가'}</DialogTitle>
            <DialogDescription>NPC-1000 표준에 따른 자재 정보를 입력하세요.</DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            <div>
              ...
              >
                ...
                <CustomSelectContent>
                  {Array.from(categoryHierarchy.values()).map(
                    rootCategory =>
                      Array.isArray(rootCategory.children) &&
                      rootCategory.children.map((subCategory: unknown) => (
            ...
            <div>
              <Label htmlFor="supplier">시공업체</Label>
              <Input
                id="supplier"
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmit}>{editingMaterial ? '수정' : '추가'}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
