        ...
        <div className="flex items-center gap-3">
          ...
          <button className={`${btnClass} relative`} onClick={onNotificationClick}>
            <div className="relative">
              <Bell size={20} />
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-[var(--danger)] text-white text-[10px] font-black w-[16px] h-[16px] flex items-center justify-center rounded-full border border-[var(--bg-surface)] animate-bounce-in">
